...
SOURCES		:=	$(UNIVCORE) \
				source source/Data source/Components source/Components/Inputs source/Components/Selectors \
				lua


DATA		:=	data
INCLUDES	:=	$(UNIVCORE) \
				include include/Data include/Components include/Components/Inputs include/Components/Selectors \
				lua
