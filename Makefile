...
#---------------------------------------------------------------------------------
TARGET		:=	Universal-Edit
BUILD		:=	build
UNIVCORE	:= 	Universal-Core
SOURCES		:=	$(UNIVCORE) \
				source source/Data source/Components source/Components/HexEditor source/Components/Inputs source/Components/Selectors \
				lua


DATA		:=	data
INCLUDES	:=	$(UNIVCORE) \
				include include/Data include/Components include/Components/HexEditor include/Components/Inputs include/Components/Selectors \
				lua
...
APP_DESCRIPTION := Universal-Edit
ICON		:=	app/icon.png
...
$(OUTPUT).cia	:	$(OUTPUT).elf $(OUTPUT).smdh
	...
	@$(MAKEROM) -f cia -target t -exefslogo -o "../Universal-Edit.cia" -elf "../Universal-Edit.elf" -rsf "../app/build-cia.rsf" -banner "../app/banner.bin" -icon "../app/icon.bin" -logo "../app/logo.bcma.lz" -DAPP_ROMFS="$(TOPDIR)/$(ROMFS)" -major $(VERSION_MAJOR) -minor $(VERSION_MINOR) -micro $(VERSION_MICRO) -DAPP_VERSION_MAJOR="$(VERSION_MAJOR)"
