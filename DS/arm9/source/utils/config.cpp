...
void Config::load() {
	FILE* file = fopen(sdFound() ? "sd:/_nds/universal-edit/config.json" : "fat:/_nds/universal-edit/config.json", "r");
	if(file) {
...
void Config::save() {
	FILE* file = fopen(sdFound() ? "sd:/_nds/universal-edit/config.json" : "fat:/_nds/universal-edit/config.json", "w");
	if(file) {
